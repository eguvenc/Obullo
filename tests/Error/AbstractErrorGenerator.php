...
class AbstractErrorGeneratorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRenderErrorNotFound()
    {
        ...
        $this->assertContains('The page you are looking for could not be found', $html);
    }
